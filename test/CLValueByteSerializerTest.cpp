...
void CLValue_ByteSer_U128_Test(void)
{
    ...
    std::string expected_u128_2 = "120000000110feffffffffffffffffffffffffffffff0d06";
...
void CLValue_ByteSer_U256_Test(void)
{
    ...
    // Optional U256
    uint256_t u256_b_val_2 = u256FromHex("20FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF");
    ...
    std::string expected_opt_u256 = "2200000001207fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"
                                    "ffff0d07";
...
void CLValue_ByteSer_U512_Test(void)
{
    ...
    // Optional U512
    uint512_t u512_val_2 = u512FromHex("40FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF"
                                       "FF"
    ...
    std::string expected_clv_opt_u512 = "4200000001407fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"
...
void CLValue_ByteSer_String_Test(void)
{
    ...
    std::string expected_opt_str = "13000000010e00000048656c6c6f2c20436173706572210d0a";
...
void CLValue_ByteSer_URef_Test(void)
{
    ...
    CLValue uref_val = CLValue::URef("uref-000102030405060708090a0b0c0d0e0f000102030405060708090a0b0c0d0e0f-"
                                     "007");

    std::string expected_uref = "21000000000102030405060708090a0b0c0d0e0f000102030405060708090a0b0c0d0e0f"
                                "070c";
    ...
    // Optional URef
    CLValue clv_opt_uref =
        CLValue::Option(CLValue::URef("uref-000102030405060708090a0b0c0d0e0f000102030405060708090a0b0c0d0e0f-"
                                      "007"));
    std::string expected_opt_uref = "2200000001000102030405060708090a0b0c0d0e0f000102030405060708090a0b0c0d0e"
                                    "0f070d0c";
...
void CLValue_ByteSer_Key_Test(void)
{
    ...
    std::string expected_acc_key_str = "2100000000989ca079a5e446071866331468ab949483162588d57ec13ba6bb051f1e15f8"
                                       "b70b";
    ...
    std::string expected_opt_acc_hash_key_str =
        ...
        "f8b70d0b";
    std::string actual_opt_acc_hash_key_str = hexEncode(ser.ToBytes(clv_opt_acc_hash_key));
    std::cout << "optional account hash key: " << actual_opt_acc_hash_key_str << std::endl;
    ...
    std::string actual_opt_none_acc_hash_key_str = hexEncode(ser.ToBytes(clv_opt_none_acc_hash_key));

    std::cout << "optional none account hash key: " << actual_opt_none_acc_hash_key_str << std::endl;
    TEST_ASSERT(expected_opt_none_acc_hash_key_str == actual_opt_none_acc_hash_key_str);
}
...
void CLValue_ByteSer_PublicKey_Test(void)
{
    ...
    // Public Key
    Casper::PublicKey pk =
        Casper::PublicKey::FromHexString("01381b36cd07Ad85348607ffE0fA3A2d033eA941D14763358eBEacE9C8aD3cB771");
    CLValue clv_pk = CLValue::PublicKey(pk);
    std::string expected_pk_str = "2100000001381b36cd07ad85348607ffe0fa3a2d033ea941d14763358ebeace9c8ad3cb7"
                                  "7116";
    ...
    std::string expected_opt_pk_str = "220000000101381b36cd07ad85348607ffe0fa3a2d033ea941d14763358ebeace9c8ad3c"
                                      "b7710d16";
    ...
    std::cout << "optional none public key: " << actual_opt_none_pk_str << std::endl;
...
void CLValue_ByteSer_List_Test(void)
{
    ...
    std::string expected_list_str = "1400000004000000010000000200000003000000040000000e04";
    ...
    std::string expected_opt_list_str = "150000000104000000010000000200000003000000040000000d0e04";
    ...
    // Optional None List
    CLValue clv_opt_none_list = CLValue::OptionNone(CLType(CLTypeEnum::U32, CLTypeEnum::List));

    std::string expected_opt_none_list_str = "01000000000d0e04";
    std::string actual_opt_none_list_str = hexEncode(ser.ToBytes(clv_opt_none_list));
    ...
    // Empty List
    CLValue clv_empty_list = CLValue::EmptyList(CLType(CLTypeEnum::Key, CLTypeEnum::List));
...
void CLValue_ByteSer_ByteArray_Test(void)
{
    ...
    // Optional ByteArray
    CLValue clv_opt_byte_array = CLValue::Option(CLValue::ByteArray(byte_array_bytes));
    std::string expected_opt_byte_array_str = "090000000101020304050607080d0f08000000";
    std::string actual_opt_byte_array_str = hexEncode(ser.ToBytes(clv_opt_byte_array));
    std::cout << "optional byte array: " << actual_opt_byte_array_str << std::endl;
    ...
    std::string actual_opt_none_byte_array_str = hexEncode(ser.ToBytes(clv_opt_none_byte_array));
    std::cout << "optional none byte array: " << actual_opt_none_byte_array_str << std::endl;
    TEST_ASSERT(expected_opt_none_byte_array_str == actual_opt_none_byte_array_str);
}
...
void CLValue_ByteSer_Result_Test(void)
{
    ...
    // Result Ok
    CLValue clv_result_ok = CLValue::Ok(CLValue::U8(255), CLType(CLTypeEnum::String));
    ...
    // Optional Result Ok
    CLValue clv_opt_result_ok = CLValue::Option(CLValue::Ok(CLValue::U8(255), CLType(CLTypeEnum::String)));

    std::string expected_opt_result_ok_str = "030000000101ff0d10030a";
    std::string actual_opt_result_ok_str = hexEncode(ser.ToBytes(clv_opt_result_ok));
    ...
    // Result Err
    CLValue clv_result_err = CLValue::Err(CLValue::String("Error!"), CLType(CLTypeEnum::Unit));
    ...
    // Optional Result Err
    CLValue clv_opt_result_err = CLValue::Option(CLValue::Err(CLValue::String("Error!"), CLType(CLTypeEnum::Unit)));

    std::string expected_opt_result_err_str = "0c0000000100060000004572726f72210d10090a";
    std::string actual_opt_result_err_str = hexEncode(ser.ToBytes(clv_opt_result_err));
    std::cout << "optional result err: " << actual_opt_result_err_str << std::endl;
    TEST_ASSERT(expected_opt_result_err_str == actual_opt_result_err_str);

    // Optional None Result Err
    CLValue clv_opt_none_result_err =
        CLValue::OptionNone(CLType(CLTypeEnum::U8), CLType(CLTypeEnum::String), CLTypeEnum::Result);

    std::string expected_opt_none_result_err_str = "01000000000d10030a";
    std::string actual_opt_none_result_err_str = hexEncode(ser.ToBytes(clv_opt_none_result_err));
    std::cout << "optional none result err: " << actual_opt_none_result_err_str << std::endl;
    TEST_ASSERT(expected_opt_none_result_err_str == actual_opt_none_result_err_str);
}
...
void CLValue_ByteSer_Map_Test(void)
{
    ...
    std::string expected_map_str = "1c00000002000000040000006b65793101000000040000006b65793202000000110a04";
    ...
    std::string expected_opt_map_str = "1d0000000102000000040000006b65793101000000040000006b657932020000000d110a"
                                       "04";
    ...
    // Optional None Map
    CLValue clv_opt_none_map = CLValue::OptionNone(CLType(CLTypeEnum::String), CLType(CLTypeEnum::U32));

    std::string expected_opt_none_map_str = "01000000000d110a04";
    std::string actual_opt_none_map_str = hexEncode(ser.ToBytes(clv_opt_none_map));
    std::cout << "optional none map: " << actual_opt_none_map_str << std::endl;
    TEST_ASSERT(expected_opt_none_map_str == actual_opt_none_map_str);

    // Empty Map
    CLValue clv_empty_map = CLValue::EmptyMap(CLType(CLTypeEnum::String), CLType(CLTypeEnum::Key));
...
void CLValue_ByteSer_Tuple1_Test(void)
{
    ...
    // Optional Tuple1
    CLValue clv_opt_tuple1 = CLValue::Option(CLValue::Tuple1(CLValue::String("ABCDE")));
    ...
    std::string actual_opt_none_tuple1_str = hexEncode(ser.ToBytes(clv_opt_none_tuple1));
    std::cout << "optional none tuple1: " << actual_opt_none_tuple1_str << std::endl;
...
void CLValue_ByteSer_Tuple2_Test(void)
{
    ...
    CLValue clv_tuple2_str = CLValue::Tuple2(CLValue::U32(127), CLValue::String("ABCDE"));
    std::string expected_tuple2_str_str = "0d0000007f00000005000000414243444513040a";
    ...
    // Optional Tuple2
    CLValue clv_opt_tuple2 = CLValue::Option(CLValue::Tuple2(CLValue::U32(127), CLValue::String("ABCDE")));
    std::string expected_opt_tuple2_str = "0e000000017f0000000500000041424344450d13040a";
    ...
    CLValue clv_opt_none_tuple2 = CLValue::OptionNoneTuple2(CLTypeEnum::U32, CLTypeEnum::String);
    std::string expected_opt_none_tuple2_str = "01000000000d13040a";
    std::string actual_opt_none_tuple2_str = hexEncode(ser.ToBytes(clv_opt_none_tuple2));
    std::cout << "optional none tuple2: " << actual_opt_none_tuple2_str << std::endl;
...
void CLValue_ByteSer_Tuple3_Test(void)
{
    ...
    CLValue clv_tuple3 = CLValue::Tuple3(CLValue::U32(17), CLValue::U32(127), CLValue::U32(17));
    ...
    CLValue clv_tuple3_str = CLValue::Tuple3(CLValue::U32(127), CLValue::String("ABCDE"), CLValue::U32(127));
    std::string expected_tuple3_str_str = "110000007f0000000500000041424344457f00000014040a04";
    ...
    // Optional Tuple3
    CLValue clv_opt_tuple3 =
        CLValue::Option(CLValue::Tuple3(CLValue::U32(127), CLValue::String("ABCDE"), CLValue::U32(127)));
    std::string expected_opt_tuple3_str = "12000000017f0000000500000041424344457f0000000d14040a04";
    ...
    CLValue clv_opt_none_tuple3 = CLValue::OptionNoneTuple3(CLTypeEnum::U32, CLTypeEnum::String, CLTypeEnum::U32);
    std::string expected_opt_none_tuple3_str = "01000000000d14040a04";
    std::string actual_opt_none_tuple3_str = hexEncode(ser.ToBytes(clv_opt_none_tuple3));
    std::cout << "optional none tuple3: " << actual_opt_none_tuple3_str << std::endl;
