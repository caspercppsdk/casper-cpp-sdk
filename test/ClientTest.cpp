...
void clValue_with_OptionU64Test()
{
    clValue_with_jsonFile("OptionU64.json");
}

void clValue_with_ListTest()
{
...
void clValue_with_ListU8Test()
{
    clValue_with_jsonFile("ListU8.json");
}

void clValue_with_ListU256Test()
{
...
void clValue_with_ResultOkTest()
{
...
void clValue_with_MapTest()
{
    clValue_with_jsonFile("Map.json");
}

void clValue_with_Tuple1Test()
{
    clValue_with_jsonFile("Tuple1.json");
}

void clValue_with_Tuple2Test()
{
    clValue_with_jsonFile("Tuple2.json");
}

void clValue_with_Tuple3Test()
{
    clValue_with_jsonFile("Tuple3.json");
}

void clValue_with_AnyTest()
{
...
TEST_LIST = {
    ...
    {"StoredContractByHashSerialization", DeployItem_ByteSer_StoredContractByHash_Test},
    {"StoredContractByNameSerialization", DeployItem_ByteSer_StoredContractByName_Test},
    {"StoredVersionedContractByHashSerialization", DeployItem_ByteSer_StoredVersionedContractByHash_Test},
    {"StoredVersionedContractByNameSerialization", DeployItem_ByteSer_StoredVersionedContractByName_Test},
    ...
    {"chainGetStateRootHash using invalid Block height parameter", chainGetStateRootHash_with_invalidBlockHeightTest},
    {"chainGetStateRootHash using Block hash parameter", chainGetStateRootHash_with_blockHashTest},
    {"chainGetStateRootHash using empty Block hash parameter ", chainGetStateRootHash_with_emptyParameterTest},
    {"infoGetDeploy using Deploy hash parameter", infoGetDeploy_with_deployHashTest},
    {"infoGetDeploy using invalid Deploy hash parameter", infoGetDeploy_with_invalidDeployHashTest},
    {"infoGetStatus compares with a reference value", infoGetStatus_with_emptyParameterTest},
    {"chainGetBlockTransfers using Block hash parameter", chainGetBlockTransfers_with_blockHashTest},
    {"chainGetBlock using Block hash parameter", chainGetBlock_with_blockHashTest},
    {"chainGetEraInfoBySwitchBlock using Block hash parameter ", chainGetEraInfoBySwitchBlock_with_blockHashTest},
    {"stateGetItem using state root hash and key parameters ", stateGetItem_with_keyTest},
    {"stateGetItem using invalid state root hash and key parameters ", stateGetItem_with_invalidKeyTest},
    {"stateGetDictionaryItem using state root hash and dictionary key "
     " parameters ",
     stateGetDictionaryItem_with_keyTest},
    {"stateGetBalance compares with a reference value", stateGetBalance_with_urefTest},
    {"stateGetBalance using invalid URef and state root hash parameters ", stateGetBalance_with_invalidUrefTest},
    {"stateGetAuctionInfo using Block hash parameter (may take a while)", stateGetAuctionInfo_with_blockHashTest},
    {"PutDeploy RPC Call with a Stored Contract by Name", PutDeploy_StoredContractByName_Test},
    {"PutDeploy RPC Call with a Transfer", PutDeploy_Transfer_Test},
    {"PutDeploy RPC Call with a Stored Contract by Hash", PutDeploy_StoredContractByHash_Test},
    ...
    {"CLValue using Option<List<Key>> = NULL", clValue_with_OptionListKeyNULLTest},
