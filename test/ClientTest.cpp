...
void publicKey_getAccountHashTest()
{
    ...
    // TODO: compareString(accountHash, expectedAccountHash);
}
...
void cltype_test()
{
    ...
    EXPECT_TRUE(threeWayCompare(map_type));
}
...
void cltype_str_list_test()
{
    ...
    // assert that the serialization-deserialization is correct
    EXPECT_TRUE(threeWayCompare(list_type));
}
...
void clType_option_test()
{
    ...
    // assert that the serialization-deserialization is correct
    EXPECT_TRUE(threeWayCompare(opt_type));
}
...
void clType_tuple1_test()
{
    ...
    EXPECT_TRUE(threeWayCompare(tuple1_type));
}
...
void clType_tuple2_test()
{
    ...
    EXPECT_TRUE(threeWayCompare(tuple2_type));
}
...
void clType_tuple3_test()
{
    ...
    EXPECT_TRUE(threeWayCompare(tuple3_type));
}
...
void clValue_with_jsonFile(std::string file_name)
{
    ...
    // compare the final parsed json with the initial json
    // TODO: compareString(generated_json.dump(), input_json.dump());
}
...
template <typename T> void globalStateKey_serialize(T key, std::string& expected_bytes_str)
{
    ...
    // TODO: compareString(expected_bytes_str, bytes_str);
}
