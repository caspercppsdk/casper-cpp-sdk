...
inline std::string hexEncode(CBytes decoded)
{
    ...
    CryptoPP::StringSource ss(decoded, decoded.size(), true,
...
inline void to_json(nlohmann::json& j, const uint128_t& p)
{
    j = u128ToDec(p);
}
...
inline void to_json(nlohmann::json& j, const uint256_t& p)
{
    j = u256ToDec(p);
}
...
inline void to_json(nlohmann::json& j, const uint512_t& p)
{
    j = u512ToDec(p);
}
...
{
    static void to_json(json& j, const uint128_t& var) { ::Casper::to_json(j, var); }

    static void from_json(const json& j, uint128_t& var) { ::Casper::from_json(j, var); }
};

template <>
struct adl_serializer<uint256_t>
{
    static void to_json(json& j, const uint256_t& var) { ::Casper::to_json(j, var); }

    static void from_json(const json& j, uint256_t& var) { ::Casper::from_json(j, var); }
};
template <>
struct adl_serializer<uint512_t>
{
    static void to_json(json& j, const uint512_t& var) { ::Casper::to_json(j, var); }

    static void from_json(const json& j, uint512_t& var) { ::Casper::from_json(j, var); }
};
} // namespace nlohmann
