...
namespace Casper {
    ...
    struct JsonBlockBody {
        JsonBlockBody (std::vector<std::string> deploy_hashes_, std::string proposer_, std::vector<std::string> transfer_hashes_)
        : deploy_hashes(deploy_hashes_), proposer(proposer_), transfer_hashes(transfer_hashes_) {}
