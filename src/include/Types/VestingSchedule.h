...
{
    j = nlohmann::json{"initial_release_timestamp_millis", p.initial_release_timestamp_millis, "locked_amounts",
                       nlohmann::json::array()};
...
{
    j.at("initial_release_timestamp_millis").get_to(p.initial_release_timestamp_millis);
